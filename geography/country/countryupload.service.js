...
var CountryUploadService = (function (_super) {
    __extends(CountryUploadService, _super);
    function CountryUploadService(http, sharedService) {
        return _super.call(this, http, sharedService) || this;
    }
    CountryUploadService.prototype.processData = function (uploadData, modalData) {
        var configurationList = new Array();
        uploadData.forEach(function (data) {
            var currentConfiguration = new country_model_1.Country();
    ...
    return CountryUploadService;
}(geniejs_1.UploadService));
CountryUploadService = __decorate([
    core_1.Injectable(),
    __metadata("design:paramtypes", [http_1.Http, geniejs_1.SharedService])
], CountryUploadService);
exports.CountryUploadService = CountryUploadService;
//# sourceMappingURL=countryupload.service.js.map