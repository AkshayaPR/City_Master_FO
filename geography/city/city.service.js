...
var CityService = (function (_super) {
    ...
    function CityService(http, sharedService, modelProviderService) {
        return _super.call(this, http, sharedService, modelProviderService) || this;
    }
    CityService.prototype.getBaseRequestPath = function () {
        return "/geography/city";
    };
    CityService.prototype.setModuleId = function () {
        return module.id;
    };
    CityService.prototype.findByCityCode = function (CityCode) {
