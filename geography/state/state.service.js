...
var StateService = (function (_super) {
    ...
    function StateService(http, sharedService, modelProviderService) {
        return _super.call(this, http, sharedService, modelProviderService) || this;
    }
    StateService.prototype.getBaseRequestPath = function () {
        return "/geography/state";
    };
    StateService.prototype.setModuleId = function () {
        return module.id;
    };
    StateService.prototype.findByCode = function (code) {
